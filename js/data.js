...
const DEFAULT_MENUS = [
  { id: 'm1', name: '아메리카노', category: 'coffee', price: 4000, image: '/img/menus/m1.jpg', description: '깊고 진한 에스프레소와 물의 조화.', soldOut: false, origin: '콜롬비아', originNote: '부드럽고 균형 잡힌 산미에 은은한 카라멜향.' },
  { id: 'm2', name: '카페라떼', category: 'coffee', price: 4500, image: '/img/menus/m2.jpg', description: '부드러운 우유와 에스프레소의 균형.', soldOut: false, origin: '브라질', originNote: '고소하고 묵직한 바디감, 낮은 산미로 우유와 잘 어울림.' },
  { id: 'm3', name: '카푸치노', category: 'coffee', price: 4500, image: '/img/menus/m3.jpg', description: '풍성한 우유 거품이 올라간 클래식.', soldOut: false, origin: '에티오피아', originNote: '화사한 꽃향과 밝은 산미가 특징인 커피의 고향 원두.' },
  { id: 'm4', name: '바닐라라떼', category: 'coffee', price: 5000, image: '/img/menus/m4.jpg', description: '달콤한 바닐라 시럽이 더해진 라떼.', soldOut: true, origin: '과테말라', originNote: '초콜릿과 스파이시함이 어우러진 풍부한 풍미.' },
  ...
  { id: 'm12', name: '콜드브루', category: 'coffee', price: 4800, image: '/img/menus/m12.jpg', description: '저온으로 오래 우려낸 부드러운 커피.', soldOut: false, origin: '케냐', originNote: '진한 베리류의 산미와 와인 같은 풍미가 매력적.' },
];
